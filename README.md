...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/square-cherry-9c72
```

A live public deployment of this template is available at [https://square-cherry-9c72.templates.workers.dev](https://square-cherry-9c72.templates.workers.dev)
